...
navbar = dbc.Navbar(
    children=[
        html.A(
            dbc.Row(
                [
                    dcc.Link(dbc.Col(html.Img(src='data:image/png;base64,{}'.format(encoded_image.decode()),height="30px")), href='/apps/register'),
                    dcc.Link('CADASTRO DE USUÁRIOS ', href='/apps/register'),
